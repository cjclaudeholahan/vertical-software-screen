...
const RAW=[
  ...
  {name:"AppFolio",vertical:"Real Estate / PropTech",sor:true,seat:false,pricing:"Usage-Based",peOwned:false,tev:6132,ntmRev:1144,growth:17,gm:64,ebitda:29,cagr:18,ntmRevX:5.4,peFit:"High",aiRisk:"Low",avoid:false,
   ...
   thesis:["AppFolio's real business is a payments company dressed as software — tenant rent payments, screening fees, and insurance premiums flow through AppFolio's ledger, creating ~$400M of payments revenue growing 25%+ that is completely decoupled from property manager headcount or AI productivity","The screening fee monopoly is underappreciated: AppFolio charges tenants $40-50 per application (not the property manager); this is a per-transaction tax on America's rental market that grows with rent prices and application volume, not software seats","At $6.1B TEV, the real question is whether this is a 15x payments multiple or a 5.4x software multiple — if you value the payments stream at payments-company multiples (8-12x revenue) and back into the software for free, the upside is significant","Competitive risk from Yardi, RealPage (now Thoma Bravo-owned), and Entrata is concentrated in mid-market/enterprise; AppFolio owns the sub-500 unit SMB segment where implementation simplicity matters more than configurability — this segment is hard to attack from above","Key risk: regulatory scrutiny of tenant screening fees (several state bills proposed) could cap the highest-margin revenue line; also, RealPage's antitrust issues around algorithmic rent-setting create headline risk for the entire PropTech sector"],
  ...
  {name:"Blackbaud",vertical:"Education / Nonprofit",sor:true,seat:true,pricing:"Seat-Based",peOwned:false,tev:2622,ntmRev:1180,growth:4,gm:62,ebitda:37,cagr:2,ntmRevX:2.2,peFit:"Medium",aiRisk:"High",avoid:false,
  ...
  {name:"nCino",vertical:"Financial Services",sor:true,seat:false,pricing:"Usage-Based",peOwned:false,tev:2083,ntmRev:644,growth:8,gm:67,ebitda:26,cagr:9,ntmRevX:3.2,peFit:"Medium",aiRisk:"Medium",avoid:false,
  ...
  // ── DATA & ANALYTICS ──
  {name:"Fair Isaac (FICO)",vertical:"Financial Services",sor:false,seat:false,pricing:"Usage-Based",peOwned:false,tev:36380,ntmRev:2665,growth:21,gm:85,ebitda:62,cagr:19,ntmRevX:13.7,peFit:"Low",aiRisk:"Low",avoid:false,
  ...
  {name:"Broadridge Financial",vertical:"Financial Services",sor:false,seat:false,pricing:"Usage-Based",peOwned:false,tev:24699,ntmRev:7574,growth:5,gm:31,ebitda:25,cagr:6,ntmRevX:3.3,peFit:"Low",aiRisk:"Low",avoid:false,
  ...
  {name:"Sportradar",vertical:"Sports Tech",sor:false,seat:false,pricing:"Usage-Based",peOwned:false,tev:5331,ntmRev:1908,growth:21,gm:75,ebitda:26,cagr:21,ntmRevX:2.8,peFit:"Medium",aiRisk:"Low",avoid:false,
  ...
  {name:"Synopsys",vertical:"Construction & Design",sor:false,seat:false,pricing:"Usage-Based",peOwned:false,tev:90364,ntmRev:9960,growth:26,gm:83,ebitda:41,cagr:20,ntmRevX:9.1,peFit:"Low",aiRisk:"Low",avoid:false,
   ...
   thesis:["Synopsys + Cadence is the closest duopoly in enterprise software — every advanced chip (sub-7nm) requires their tools, TSMC/Samsung fab processes are co-optimized with Synopsys","26% growth inflated by Ansys acquisition; organic EDA growth closer to 12-15% — still excellent but headline overstates underlying momentum","$90B TEV at 9.1x NTM is a public markets compounder, not PE — even mega-funds cannot underwrite a take-private at this scale","Ansys deal creates simulation-to-silicon platform that is genuinely differentiated, but integration risk is real with 2-3 years of execution complexity","Benchmark: gold standard for mission-critical AI-tailwind software — use as the quality ceiling when evaluating other screen names"],
  ...
  {name:"Constellation Software",vertical:"Diversified VSaaS",sor:true,seat:false,pricing:"Usage-Based",peOwned:false,tev:43200,ntmRev:13813,growth:16,gm:29,ebitda:29,cagr:16,ntmRevX:3.1,peFit:"Low",aiRisk:"Medium",avoid:false,
   ...
   thesis:["The bull case (disciplined VMS acquirer compounding at 16%) is well-understood — the bear is that many of 800+ portfolio cos are exactly the small niche workflow tools AI disrupts first","29% GM means many subs are services-heavy, not pure software — legacy on-prem tools with aging codebases where AI-native alternatives have the largest quality gap to exploit","Organic growth ex-M&A is likely low-single-digits across the portfolio — the acquisition machine masks what may be structural decline in many individual business units","$43B TEV at 3.1x NTM is not PE-actionable, but the real question is whether CSU can sustain acquisition returns when every PE fund now competes for the same VMS targets","Benchmark with a caveat: diversification is not insulation — if 30% of subs face serious AI disruption, portfolio ROIC degrades even if the M&A flywheel continues"],
  ...
  // ── LOW GROWTH / OTHER ──
  {name:"SS&C Technologies",vertical:"Financial Services",sor:true,seat:false,pricing:"Usage-Based",peOwned:false,tev:26432,ntmRev:6771,growth:7,gm:58,ebitda:40,cagr:6,ntmRevX:3.9,peFit:"Low",aiRisk:"Medium",avoid:false,
  ...
  {name:"Diebold Nixdorf",vertical:"Financial Services",sor:false,seat:false,pricing:"Usage-Based",peOwned:false,tev:3778,ntmRev:3901,growth:2,gm:27,ebitda:14,cagr:2,ntmRevX:1.0,peFit:"Low",aiRisk:"High",avoid:true,
